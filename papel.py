...
class Papel:
    ...
    def run(self):
        while True:
            ...
            catpapel = Button(image=pygame.image.load("Resourses/Trash_shop/Books/Bluebookbutton.png"),
                              pos=(150, 380),
                              text_input="", font=self.get_font(50), base_color="#ffffff", hovering_color="#efa40f")
            catpapel2 = Button(image=pygame.image.load("Resourses/Trash_shop/Books/Redbookbutton.png"),
                               pos=(600, 380),
                               text_input="", font=self.get_font(50), base_color="#ffffff", hovering_color="#efa40f")
            catpapel3 = Button(image=pygame.image.load("Resourses/Trash_shop/Books/Purplebookbutton.png"),
                               pos=(1150, 380),
                               text_input="", font=self.get_font(50), base_color="#ffffff", hovering_color="#efa40f")
            ...
            for button in [catpapel, catpapel2, catpapel3, BACK_BUTTON]:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if BACK_BUTTON.checkForInput(MENU_MOUSE_POS):
                        self.opc = "back"
                        return
                    if catpapel.checkForInput(MENU_MOUSE_POS):
                        print("juju")
                        return
                    if catpapel2.checkForInput(MENU_MOUSE_POS):
                        print("juj")
                        return
                    if catpapel3.checkForInput(MENU_MOUSE_POS):
                        print("ju")
                        return
