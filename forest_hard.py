...
class Level_f_2:
    ...
    def run(self):
        ...
        text_trash_collected = self.get_font(18).render(f"{self.trash_collected}/80",True, (255,255,255))
        #Trash on the ground counter
        text_trash_on_ground = self.get_font(18).render(f"{trash_on_floor}/70", True, (255,255,255))
